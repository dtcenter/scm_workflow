...
def plot_profile_multi(z, values, labels, x_label, y_label, title, captions, filename, obs_z=None, obs_values=None, xticks=[], yticks=[], y_inverted = False, y_log = False, y_lim = [], conversion_factor=1.0, freeze_axis=None, line_type=None, color_index=None, skill_scores=False, zero_line=False):
    #xticks = [x_start, x_end, x_num]
    plt.rc('text', usetex=latex_labels)
    ...
    plt.ylabel(y_label)
    plt.title(title)
    fig.text(0.2, 0.0, captions, ha='center', fontsize=9)
